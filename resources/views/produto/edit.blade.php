                    ...
                    <form method="POST" action="{{ route('produto.update',$produto->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control flareeditor-input-orange" id="descricao"
                                placeholder="Descrição Do Produto" name="descricao" value="{{ $produto->descricao }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control flareeditor-input-orange" id="vendedor" name="vendedor">
                                ...
                                <option value="{{ $vendedor->id }}" @if ($produto->vendedor_id == $vendedor->id) selected @endif>{{$vendedor->nome}}</option>
                                @endforeach
                              </select>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control flareeditor-input-orange" id="preco"
                                        placeholder="Preco Do Produto" name="preco" value="{{ $produto->preco }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control flareeditor-input-orange" id="link"
                                        placeholder="Link Do Produto" name="link" value="{{ $produto->link }}">
                                </div>
                            </div>
                        </div>
