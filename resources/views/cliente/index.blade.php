...
@endsection
@section('bodyContent')
    <a role="button" class="btn btn-primary m-2" href="{{ route('cliente.create') }}">Cadastrar Novo Cliente</a><br>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Deseja apagar o cliente <b>{{ $cliente->nome . ' ' . $cliente->sobrenome }}</b>? </p>
                            <p></p>
