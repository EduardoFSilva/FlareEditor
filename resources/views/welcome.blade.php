...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Painel De
                        Controle</a>
                @else
                ...
                @endauth
            @endif
            <a href="{{ route('editor') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Editor</a>
        </div>
